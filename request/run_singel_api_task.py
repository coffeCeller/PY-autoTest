...
def readSQL():
    ...
    coon = pymysql.connect(user='root',password='hsn123456',db='autotest', port=3306, host='127.0.0.1',charset='utf8')
    cursor = coon.cursor()
...
def read_Results():
    db = pymysql.connect(user='root',password='hsn123456',db='autotest', port=3306, host='127.0.0.1',charset='utf8')
    cursor = db.cursor()
